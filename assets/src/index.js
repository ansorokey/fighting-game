...
// https://github.com/ansorokey/fighting-game.git
...
const background = new Sprite({
    ...
    // imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/background/decorated background.png'
    imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/background/decorated background.png'
})
...
const shop = new Sprite({
    ...
    imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/decorations/shop_anim.png',
    scale: 2.75,
    maxFrames: 6
})
...
const player = new Fighter({
    ...
    imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player1/Idle.png',
    maxFrames: 8,
    scale: 2.5,
    offset: {
        x: 215,
    ...
    sprites: {
        ...
        run: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player1/Run.png',
            maxFrames: 8
        },
        runLeft: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player1/Run_left.png',
            maxFrames: 8
        },
        jump: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player1/Jump.png',
            maxFrames: 2
        },
        fall: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player1/Fall.png',
            maxFrames: 2
        },
        attack1: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player1/Attack1.png',
            maxFrames: 6
        },
        takeHit: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player1/Take Hit.png',
            maxFrames: 4
        },
        death: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player1/Death.png',
            maxFrames: 6
        },
    },
    attackBox: {
...
const enemy = new Fighter({
    ...
    imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player2/Idle.png',
    maxFrames: 4,
    scale: 2.5,
    offset: {
        x: 215,
    ...
    sprites: {
        ...
        run: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player2/Run.png',
            maxFrames: 8
        },
        runLeft: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player2/Run_left.png',
            maxFrames: 8
        },
        jump: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player2/Jump.png',
            maxFrames: 2
        },
        fall: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player2/Fall.png',
            maxFrames: 2
        },
        attack1: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player2/Attack1.png',
            maxFrames: 4
        },
        takeHit: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player2/Take hit.png',
            maxFrames: 3
        },
        death: {
            imgSrc: 'https://github.com/ansorokey/fighting-game/assets/assets/images/player2/Death.png',
            maxFrames: 7
        },
    },
    attackBox: {
